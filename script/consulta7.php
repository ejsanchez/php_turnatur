<?php
	...
	echo "
		<div>
			<form method='POST' action='consulta7_1.php' id='consulta3'>
			  <legend>Varias empresas y una cuenta en varios a&ntilde;os </legend>
			  <fieldset class='li7'>				
		";
	...
	while ($reg = mysqli_fetch_assoc($consulta)) {
		...
		if ($statement != $statementAnterior){
			...
			echo '</optgroup><optgroup label="'.$statement.'">';
		}
