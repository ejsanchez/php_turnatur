...
$optionsYE='y';
foreach ($years as $report_year=>$value) {
	if ($optionsYE=='y'){
		$optionsYE='"'.$value.'"';
	}else{
		$optionsacumYE = $optionsYE;
		$optionsYE = $optionsacumYE .',"' . $value.'"';}
}

//echo "OptionsAC".$optionsAC."+"."OptionsEN".$optionsEN."+"."optionsYE".$optionsYE;
...
$query="
	...
	AND (r.account_id IN ($optionsAC)) 
        ...
        AND (r.report_year IN ($optionsYE))
";
